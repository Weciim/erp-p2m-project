const ar_AR = {
    sign_up: "التسجيل",
    manage_your_company_with: "إدارة شركتك باستخدام",
    all_in_one_tool: "أداة شاملة",
    run_and_scale_your_erp_crm_apps: "تشغيل وتوسيع تطبيقات ERP و CRM الخاصة بك",
    easily_add_and_manage_your_services: "أضف وادخل خدماتك بسهولة",
    it_brings_together_your_invoice_clients_and_leads:
      "يجمع بين فواتيرك وعملائك والعملاء المحتملين",
    select_language: "اختر اللغة",
    register: "تسجيل",
    or: "أو",
    already_have_account_login: "هل لديك حساب بالفعل؟ سجل الدخول",
    name: "الاسم",
    ...
    complete_verification_by_providing_the_code_that_you_received_by_email:
      "أكمل التحقق من خلال تقديم الرمز الذي تلقيته عبر البريد الإلكتروني",
    ...
    password_reset_in_progress: "إعادة تعيين كلمة المرور قيد التقدم",
    check_your_email_address_to_reset_your_password:
      "تحقق من عنوان بريدك الإلكتروني لإعادة تعيين كلمة المرور",
    login: "تسجيل الدخول",
    ...
    last_invoice_number: "آخر رقم فاتورة",
    last_quote_number: "آخر رقم عرض سعر",
    last_offer_number: "آخر رقم عرض",
    last_payment_number: "آخر رقم دفع",
    ...
    advertising: "الإعلان",
    friend: "صديق",
    professionals_network: "الشبكة المهنية",
    customer_referral: "إحالة العميل",
    sales: "المبيعات",
    other: "أخرى",
    add_new: "إضافة جديد",
    date: "التاريخ",
    ...
    admin_super_admin: "المشرف العام",
    staff_admin_crud: "طاقم المشرفين CRUD",
    staff_cru: "طاقم CRU",
    ...
    offers: "العروض",
    proforma_invoices: "عروض الأسعار",
    search: "بحث",
  };
