const fr_FR = {
  ...
  run_and_scale_your_erp_crm_apps:
    "Exécutez et développez vos applications ERP et CRM",
  ...
  it_brings_together_your_invoice_clients_and_leads:
    "Il réunit vos factures, clients et prospects",
  select_fruage: "Sélectionnez la frue",
  register: "S'inscrire",
  or: "Ou",
  ...
  check_your_email_address_to_verify_your_account:
    "Vérifiez votre adresse e-mail pour vérifier votre compte",
  ...
  leads: "Prospects",
  offer_leads: "Prospects d'offres",
  invoices: "Factures",
  quotes: "Devis",
  payments: "Paiements",
  products: "Produits",
